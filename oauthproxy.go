...
func (p *OAuthProxy) OAuthCallback(rw http.ResponseWriter, req *http.Request) {
	...
	if errorString != "" {
		...
		p.ErrorPage(rw, req, http.StatusForbidden, errorString, "Login Failed: The upstream identity provider returned an error.")
		return
	}
	...
	if err != nil {
		...
		p.ErrorPage(rw, req, http.StatusInternalServerError, err.Error(), "Login Failed: There was a problem with the code returned by the upstream identity provider.")
		return
	}
